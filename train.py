...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='garbage/garbage.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='garbage/hyp.scratch.yaml', help='hyperparameters path')
